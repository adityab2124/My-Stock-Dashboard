...
#print (value_list)
# cursor execute key list into header 
# cursor execute value list into column values (row)           
...
try:
    ...
    # Create the options table if it doesn't exist #input_table will create a new table for company and date this way 
    cursor.execute('''
    ...
    # Prepare and execute SQL insert statements for each dictionary in access_data
...
# this is great, but now i need a command that if i rerun, itll wipe
#the old table away and present new data 
