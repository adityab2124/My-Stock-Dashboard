...
#now i can create new tables based on info requested
#now test if it can go to into the RDStestok connection on bench
#and then from rdstestok to aws server
